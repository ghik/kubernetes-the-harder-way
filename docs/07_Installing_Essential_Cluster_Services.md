...
$dir/nfs-pvs 192.168.42.0/24(rw,root_squash,anonuid=$uid,anongid=$gid,no_subtree_check)"
EOF
```
...
Note the allocated range for Service external IPs (192.168.42.30-254). It's important for this range to be within
...
echo-lb   LoadBalancer   10.32.89.174   192.168.42.30   5678:32479/TCP   72s
```

Try connecting to it from your host machine:

```bash
$ curl http://192.168.42.30:5678
hello-world
```
